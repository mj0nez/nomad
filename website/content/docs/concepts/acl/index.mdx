...
- **JWT**: The user or application performing the Nomad login must already be
...
- **OIDC**: The user performing the Nomad login does not have a JWT nor do
  ...
  Nomad ACL tokens to any authorized coworker who may need to have access to a
  Nomad instance. Browser interaction is required.
